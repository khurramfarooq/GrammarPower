 ...
 *
 */
public class QuizActivity_PhrasalVerbs extends SherlockFragmentActivity  {
	...
	protected void onCreate(Bundle arg0) {
		...
		yellowQuestionText.setText(R.string.pharasalverb_question);
		
		hintText.setText(R.string.hint_Smartasses);
		...
		stopBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) 
			{
				...
				if(timeArr.length > 3)
				{
					...
					AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(QuizActivity_PhrasalVerbs.this);
					// set dialog message
					alertDialogBuilder
							.setMessage(text)
							.setCancelable(false)
	...
	{	
		fileText = TextParser.readFile(getAssets(),"DLT5_fin.txt");		
	}
