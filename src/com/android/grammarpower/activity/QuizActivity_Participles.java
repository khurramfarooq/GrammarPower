 ...
 *
 */
public class QuizActivity_Participles extends SherlockFragmentActivity  {
		...
		stopBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) 
			{
				...
				if(timeArr.length > 3)
				{
					...
					AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(QuizActivity_Participles.this);
					// set dialog message
					alertDialogBuilder
							.setMessage(text)
							.setCancelable(false)
	...
	{	
		fileText = TextParser.readFile(getAssets(),"DLT2_fin.txt");		
	}
