 ...
 *
 */
public class QuizActivity_Preposition extends SherlockFragmentActivity  {
	...
	protected void onCreate(Bundle arg0) {
		...
		yellowQuestionText.setText(R.string.preposition_question);
		
		hintText.setText(R.string.hint_sophisticates);
		...
		stopBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) 
			{
				...
				if(timeArr.length > 3)
				{
					...
					AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(QuizActivity_Preposition.this);
					// set dialog message
					alertDialogBuilder
							.setMessage(text)
							.setCancelable(false)
	...
	{	
		fileText = TextParser.readFile(getAssets(),"DLT4_fin.txt");		
	}
