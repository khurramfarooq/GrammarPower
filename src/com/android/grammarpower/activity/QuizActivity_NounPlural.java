 ...
 *
 */
public class QuizActivity_NounPlural extends SherlockFragmentActivity  {
		...
		stopBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) 
			{
				...
				if(timeArr.length > 3)
				{
					...
					AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(QuizActivity_NounPlural.this);
					// set dialog message
					alertDialogBuilder
	...
	{	
		fileText = TextParser.readFile(getAssets(),"DLT3_fin.txt");		
	}
